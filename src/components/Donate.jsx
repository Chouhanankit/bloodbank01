...
const Donate = () => {
    return (
        <>
            <div className='w-full h-[60vh] bg-IMG1 bg-cover bg-right-top md:bg-center flex md:justify-start md:pl-40 justify-center items-center text-center md:text-start'>
                <span>
