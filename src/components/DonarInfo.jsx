...
const DonarInfo = () => {
    return (
        <>
            <div className='w-full flex flex-col justify-center items-center h-auto relative bg-gradient-to-br from-blue-500 '>
                ...
                <div className='w-[80%] justify-evenly items-center md:grid md:grid-cols-2 lg:grid-cols-3  grid-cols-1 grid sm:grid-cols-2 sm:flex sm:flex-wrap gap-5 p-5 py-10'>
                    ...
                    <div className="card mx-auto w-full h-[25rem] max-w-xs border-2 border-blue-800 bg-white p-0 text-gray-800 transition-transform duration-300 ease-in-out hover:scale-105">
