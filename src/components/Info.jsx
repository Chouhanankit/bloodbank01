    ...
    return (
        <>
            <div className="w-full  bg-white flex flex-col justify-start items-center ">
                ...
                <p className='text-[15px] mb-10'>Blood group of any human being will mainly fall in any one of the following groups..</p>
                ...
                <div className='w-full  flex justify-evenly items-center'>
                    <div>
                        <ul>
                            ...
                            <p className='w-[35rem] text-gray-500'>A healthy diet helps ensure a successful blood donation, and also makes you feel better! Check out the following recommended foods to eat prior to your donation.</p>
                        </ul>
                    </div>
                    <div>
